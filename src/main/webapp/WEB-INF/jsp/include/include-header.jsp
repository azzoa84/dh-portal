...
<script src="${pageContext.request.contextPath}/js/lib/external/common/angular.min.js?v=${ncid}"></script>
<script src="<c:url value='/js/lib/external/common/jquery-1.11.1.min.js?v=${ncid}'/>"></script>
<script src="<c:url value='/js/lib/external/common/jquery-ui.1.10.4.min.js?v=${ncid}'/>"></script>
<script src="<c:url value='/js/lib/external/common/jquery.bpopup.min.js?v=${ncid}'/>"></script>

<script src="<c:url value='/js/lib/external/bootstrap-3.3.2-dist/js/bootstrap.min.js?v=${ncid}'/>"></script>
